...
static inline __m128i _mm_srli_si128(__m128i a, int c) {
  ...
  if (c != 4)
    std::abort();
  __i8x16 r = (__i8x16)wasm_i32x4_replace_lane((__i32x4)a, /* index = */ 0, 0);
  return wasm_i8x16_shuffle(r, r,
...
static inline __m128i cvtps_epi32(__m128 a) {
  return __builtin_convertvector(
    (__f32x4)wasm_f32x4_nearest(a), __i32x4);
}
static inline __m128i cvttps_epi32(__m128 a) {
  return wasm_i32x4_trunc_sat_f32x4((__f32x4)a);
}
...
static inline __m128i madd_epi16(__m128i a, __m128i b) {
  ...
  return wasm_i8x16_shuffle(a, b, 31, 0, 30, 2, 29, 4, 28, 6, 27, 8, 26, 10, 25, 12, 24, 2 /* PMADDWD */);
#else
...
static inline __m128i adds_epi16(__m128i a, __m128i b) {
  // paddsw xmm, xmm
  return wasm_i16x8_add_sat((__i16x8)a, (__i16x8)b);
}
static inline __m128i maddubs_epi16(__m128i a, __m128i b) {
  // pmaddubsw xmm, xmm
#ifdef INTGEMM_WORMHOLE
  return wasm_i8x16_shuffle(a, b, 31, 0, 30, 2, 29, 4, 28, 6, 27, 8, 26, 10, 25, 12, 24, 1 /* PMADDUBSW */);
#else
  __i16x8 c =
...
static inline __m128i mul_epu32(__m128i a, __m128i b) {
  return wasm_u64x2_extmul_low_u32x4(
    wasm_i8x16_shuffle(a, a, 0, 1, 2, 3, 8, 9, 10, 11, 8, 9, 10, 11, 12, 13, 14, 15),
    wasm_i8x16_shuffle(b, b, 0, 1, 2, 3, 8, 9, 10, 11, 8, 9, 10, 11, 12, 13, 14, 15));
}
static inline __m128i abs_epi8(__m128i a) {
  return wasm_i8x16_abs((__i8x16)a);
}
